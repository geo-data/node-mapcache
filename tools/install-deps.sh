...
if [ -f ./CMakeLists.txt ]; then # it's a cmake build
    cmake CMakeLists.txt -DWITH_FCGI=0 -DWITH_SQLITE=0 -DWITH_GDAL=0 -DWITH_GEOS=0 -DWITH_APACHE=0 -DCMAKE_INSTALL_PREFIX=${PREFIX}/mapcache-install || die "cmake failed"
